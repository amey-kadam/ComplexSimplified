...
export default function TopicForm({ initialTopic = "", onSubmit }: TopicFormProps) {
  ...
  return (
    <Card className="bg-yellow-300 rounded-xl shadow-lg p-3 mb-8 card-highlight border-2 border-yellow-500 transform hover:scale-[1.01] transition-all duration-300">
      <CardContent className="pt-4">
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <div className="relative">
              <Input
                ...
                className="w-full px-4 py-3 border-2 border-blue-500 rounded-lg focus:border-blue-600 focus:ring-blue-400 text-lg bg-blue-50 shadow-inner"
                required
              />
            </div>
            ...
            <div className="flex gap-3 mt-2 justify-start">
              <label className="relative inline-block">
                ...
                />
                <div className="flex items-center px-4 py-3 text-sm border-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-700 text-white peer-checked:from-blue-600 peer-checked:to-blue-800 peer-checked:shadow-lg peer-checked:scale-105 peer-focus:ring-2 peer-focus:ring-blue-300 transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02] transform">
                  <svg
              ...
              <label className="relative inline-block">
                <input
                  ...
                  className="peer absolute opacity-0"
                />
                <div className="flex items-center px-4 py-3 text-sm border-2 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white peer-checked:from-blue-800 peer-checked:to-blue-600 peer-checked:shadow-lg peer-checked:scale-105 peer-focus:ring-2 peer-focus:ring-blue-300 transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02] transform">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2 text-white animate-pulse"
                    fill="none"
            ...
            <div className="flex flex-col space-y-3 mt-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-blue-500 border-2 border-blue-500 rounded-sm focus:ring-blue-300 accent-blue-500"
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-orange-500 border-2 border-yellow-500 rounded-sm focus:ring-orange-300 accent-yellow-500"
          ...
          <Button 
            type="submit" 
            className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold py-7 text-lg rounded-xl border-2 border-yellow-700 shadow-lg transform hover:scale-[1.02] transition-all duration-300"
          >
